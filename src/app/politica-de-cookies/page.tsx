    ...
    <div className="container mx-auto max-w-4xl py-12">
      <Card>
        ...
        <CardContent className="prose prose-invert max-w-none">
            ...
            <ul>
                <li>
                    <strong>Cookies relacionados à conta:</strong> If you create an account conosco, usaremos cookies para o gerenciamento do processo de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair do sistema, porém, em alguns casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao sair.
                </li>
                <li>
