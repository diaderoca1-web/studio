...
export default function LoginPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    setIsLoading(true);
    try {
      await login({ email: values.email, pass: values.password });
      toast({
        title: 'Sucesso!',
    ...
    <div className="flex min-h-[calc(100vh-8rem)] w-full items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">Conecte-se para acompanhar seus prêmios, depósitos e muito mais.</p>
        </div>
                ...
                render={({ field }) => (
                    <FormItem>
                         <div className="relative">
                            ...
                            <FormControl>
                                <Input placeholder="Seu e-mail" {...field} className="pl-10" />
                            </FormControl>
                        </div>
                        <FormMessage />
                    </FormItem>
                ...
                render={({ field }) => (
                    <FormItem>
                         <div className="relative">
                            ...
                            <FormControl>
                                <Input type={showPassword ? "text" : "password"} placeholder="Digite sua senha" {...field} className="pl-10 pr-20" />
                            </FormControl>
